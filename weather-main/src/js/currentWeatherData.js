...
export const currentWeatherData = async (data, key) => {
  ...
  if(currentWeatherData.main.humidity > 65 && currentWeatherData.main.humidity < 80 && currentWeatherData.main.temp > 25 && currentWeatherData.main.temp < 38 ) {
    suitable.innerText="Suitable for Rice cultivation"
  } else {
    suitable.innerText="Not suitable for Rice cultivation"
  }
